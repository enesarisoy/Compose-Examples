package com.ns.instagramclone.ui.profile
...
fun ProfileInfoPreview() {
    ProfileSection(
        firstImageId = PostDataProvider.postList.first().authorImageId,
        text = PostDataProvider.postList.first().author,
...
fun LikesSectionPreview() {
    val post = PostDataProvider.postList.first()
    ProfileSection(
